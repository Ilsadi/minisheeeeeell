...
/*   Updated: 2025/09/24 16:24:37 by ilsadi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	handle_word_branch(char *line, int *i, t_mini *mini, t_tokctx *ctx)
{
	int		start;
	char	*word;
	t_token	*tok;
...
static int	process_next_token(char *line, int *i, t_mini *mini, t_tokctx *ctx)
{
	t_token	*tok;
